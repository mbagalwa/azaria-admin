type LogoProps = {
  ...
  /** `brand` : marque orange + mot foncé. `light` : tout en clair (sur fond sombre/dégradé). */
  variant?: "brand" | "light";
  className?: string;
};

/** Logo Azaria - symbole inliné + mot-symbole optionnel. */
export function Logo({
  ...
  const markColor = variant === "light" ? "text-white" : "text-[#ff4d00]";
